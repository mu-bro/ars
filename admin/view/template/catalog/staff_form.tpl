        ...
        <div id="tab-general">
          <table class="form">
            ...
            <tr>
              ...
              <td><textarea name="descr" cols="40" id="descr" rows="5"><?php echo $descr; ?></textarea></td>
            </tr>
            <tr>
              <td><?php echo $entry_short_descr; ?></td>
              <td><textarea name="short_descr" cols="40" rows="5"><?php echo $short_descr; ?></textarea></td>
            </tr>             
            <tr>
