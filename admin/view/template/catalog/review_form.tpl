      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
           ...
           <tr>
		<td><span class="required">*</span> Дата добавления:</td>
		<td>
			<input type="text" name="date_added" class="datetime" value="<?php echo $date_added; ?>" />
		</td>
          </tr>         
          <tr>
          ...
          <tr>
            ...
            <td><textarea name="answer" cols="60" rows="8"><?php echo $answer; ?></textarea></td>
          </tr>          
        </table>
      </form>
    </div>
