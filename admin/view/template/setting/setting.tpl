      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          <table class="form">
            ...
            <tr>
              <td>Время работы:</td>
              <td><input type="text" name="config_schedule" value="<?php echo $config_schedule; ?>" size="40" />
            </tr>
            <tr>
              <td>Время работы внизу страницы:</td>
              <td>
				<textarea name="config_schedule_bottom" cols="40" rows="5"><?php echo $config_schedule_bottom; ?></textarea>
            </tr>             
            <tr>
            ...
            <tr>
              ...
              <td>
				<input type="text" name="config_telephone_pre" value="<?php echo $config_telephone_pre; ?>" size="9" />
