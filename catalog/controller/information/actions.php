...
class ControllerInformationActions extends Controller {
	public function index() {
    	$this->data = array_merge( $this->data , $this->language->load('information/actions'));
		...
		if ($news_info) {
			...
			$this->data['breadcrumbs'][] = array(
				'href'      => $this->url->link('information/actions', 'news_id=' . $this->request->get['news_id']),
			...
			$this->data['news'] = $this->url->link('information/actions');
			...
			$limit = 7;
	  		...
	  		$news_data = $this->model_fido_news->getNews($page,$limit,'actions');
	  		
	  		$news_total = $this->model_fido_news->getTotalNews('actions');
