...
class Currency {
	...
	public function format($number, $currency = '', $value = '', $format = true, $htmlEntities = false) {
		...
		if (($symbol_left) && ($format)) {
			if ($htmlEntities) {
				$string .= "<span class='curSymbol'>" . $symbol_left . "</span>";
			} else {
				$string .= $symbol_left;
			}
		}
		...
		if (($symbol_right) && ($format)) {
			if ($htmlEntities) {
				$string .= "<span class='curSymbol'>" . $symbol_right . "</span>";
			} else {
				$string .= $symbol_right;
			}			
		}
